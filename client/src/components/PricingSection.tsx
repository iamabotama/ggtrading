/* GG Trading Pricing / Membership Section
   Design: Three-tier pricing with violet highlight on Pro plan
   Dark panels, feature lists, CTA buttons */
...
const plans = [
  ...
  },
  {
    ...
    highlight: true,
    borderClass: "border-[oklch(0.48_0.26_292)/60%]",
    ctaStyle: "bg-[oklch(0.48_0.26_292)] hover:bg-[oklch(0.55_0.26_292)] text-white font-bold cta-pulse",
  },
  {
    name: "Elite",
    price: "$149",
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`relative flex flex-col rounded-xl p-6 transition-all duration-300 ${
                plan.highlight
                  ? "bg-[oklch(0.13_0.06_292)] border-2 border-[oklch(0.48_0.26_292)/60%] shadow-[0_0_40px_oklch(0.48_0.26_292/25%)]"
                  : plan.borderClass
              }`}
            >
              {/* Popular badge */}
                  ...
                  <li key={feature} className="flex items-start gap-2.5 text-sm text-white/70">
                    <Check
                      ...
                      className={`flex-shrink-0 mt-0.5 ${
                        plan.highlight
                          ? "text-[oklch(0.62_0.22_292)]"
                          : "text-[oklch(0.68_0.19_162)]"
                      }`}
                    />
                    {feature}
                  </li>
              ...
              <Button
                ...
                onClick={() =>
                  toast.success(`${plan.name} membership signup coming soon! We'll notify you at launch.`)
                }
              >
                {plan.cta}
              </Button>
