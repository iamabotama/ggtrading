/* GG Trading Leadership Section
   Design: Dark panel, founder card with violet accent
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12">
          ...
          <div className="max-w-xl">
            ...
            >
              Built by a Trader,
              <br />
              <span className="gradient-text-violet-blue">For Traders.</span>
            </h2>
            <p className="text-white/60 text-lg leading-relaxed">
              GG Trading was founded on a simple conviction: serious traders deserve
              institutional-grade AI intelligence without the institutional price tag.
              Every feature, every signal, every community channel is built with that
              mission at its core.
            </p>
          </div>
          ...
          <div className="flex-shrink-0">
            <div className="gg-panel p-8 max-w-sm w-full relative overflow-hidden">
              {/* Decorative glow */}
              <div
                className="absolute -top-10 -right-10 w-40 h-40 rounded-full blur-3xl"
                style={{ background: "oklch(0.48 0.26 292 / 15%)" }}
              />
              ...
              <blockquote className="relative z-10">
                <p className="text-sm text-white/65 leading-relaxed italic">
                  "Green Gains isn't just a tagline — it's a standard. Every tool we build,
                  every signal we deliver, every session we stream is designed to put more
                  green on your screen."
                </p>
                <footer className="mt-3 text-xs text-white/35 font-mono">
                  — Brandon Iwata, Founder
                </footer>
              </blockquote>
            </div>
          </div>
