...
const socials = [
  ...
  { name: "Twitch", icon: <TwitchIcon />, color: "#9146FF", href: "#" },
];

const footerLinks = {
  Platform: ["Features", "Performance", "AI Signals", "DEX Trading", "Risk Tools"],
  Community: ["Discord", "YouTube", "Twitch", "X (Twitter)", "Newsletter"],
        ...
        <div className="container py-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div>
              ...
              >
                Ready to start your{" "}
                <span className="gradient-text-green-blue">green gains journey?</span>
              </h3>
              <p className="text-white/50 text-sm">
                Join 12,400+ traders already using GG Trading's AI intelligence.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-xs text-white/40 leading-relaxed mb-5">
              AI-powered trading intelligence for serious market participants.
            </p>
