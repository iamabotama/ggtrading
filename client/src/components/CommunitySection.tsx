/* GG Trading Community Section
   Design: Social platform cards — Discord, X, YouTube, Twitch
   Mobile: single column, stacked header, full-width cards */
...
const platforms = [
  {
    name: "Discord",
    description: "Join our private Discord server for real-time trade alerts, AI signal channels, and direct access to our analyst team. Active 24/7.",
    icon: <DiscordIcon />,
    color: "#5865F2",
  ...
  {
    name: "X (Twitter)",
    description: "Follow @GGTrading for daily market insights, AI-generated chart breakdowns, and real-time commentary on NQ and ES futures.",
    icon: <XIcon />,
    color: "#ffffff",
  ...
  {
    name: "YouTube",
    description: "Weekly deep-dive analysis, AI trading tutorials, and recorded live sessions. Subscribe for full access to our educational library.",
    icon: <YoutubeIcon />,
    color: "#FF0000",
  ...
  {
    name: "Twitch",
    description: "Live trading sessions, real-time AI signal breakdowns, and interactive Q&A with our analysts. Streaming every market day.",
    icon: <TwitchIcon />,
    color: "#9146FF",
...
export default function CommunitySection() {
  return (
    <section id="community" className="py-16 sm:py-24 relative">
      <div className="absolute inset-0 neural-grid opacity-10" />

      <div className="container relative z-10">
        {/* Header */}
        <div className="mb-10 sm:mb-16 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          ...
          <div className="flex items-center gap-3 gg-panel px-4 sm:px-5 py-3 sm:py-4 self-start">
            <Users size={18} className="text-[oklch(0.62_0.22_292)]" />
            <div>
              <div className="text-lg sm:text-xl font-bold font-mono text-white">12,400+</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
          {platforms.map((platform) => (
            <div
              key={platform.name}
              className="relative p-5 sm:p-6 rounded-xl border transition-all duration-300 group cursor-pointer"
              style={{
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1 gap-2">
                    ...
                    <span className="text-xs font-mono text-white/40 flex-shrink-0">{platform.members}</span>
                  </div>
