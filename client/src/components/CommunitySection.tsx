/* GG Trading Community Section
   Design: Social platform cards — Discord, Instagram, YouTube, Kick
...
const platforms = [
  ...
  {
    name: "Instagram",
    description: "Follow @GGTrading on Instagram for daily market insights, chart breakdowns, and real-time commentary on NQ and ES futures.",
    icon: <InstagramIcon />,
    color: "#E1306C",
  ...
  {
    name: "Kick",
    description: "Live trading sessions, real-time signal breakdowns, and interactive Q&A with Brandon. Streaming every market day.",
    icon: <KickIcon />,
    color: "#53FC18",
